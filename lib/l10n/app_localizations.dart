...
abstract class AppLocalizations {
  ...
  /// No description provided for @stats_tasks_completed.
  ///
  /// In en, this message translates to:
  /// **'Completed Tasks'**
  String get stats_tasks_completed;

  /// No description provided for @stats_goals_active.
  ///
  /// In en, this message translates to:
  /// **'Active Goals'**
  String get stats_goals_active;

  /// No description provided for @stats_goals_completed.
  ///
  /// In en, this message translates to:
  /// **'Goals Completed'**
  String get stats_goals_completed;
